   ...
   <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
    ...
    <Card className="space-y-6">
     ...
     <div className="space-y-4">
      <div>
       <label className="text-[10px] uppercase text-muted-foreground font-black mb-2 block">Project Title</label>
       <input 
        type="text" value={formData.title} 
        onChange={(e) => setFormData({...formData, title: e.target.value})}
        className="w-full bg-foreground/5 border border-border rounded-xl p-4 text-foreground focus:border-foreground transition-colors outline-none" required
       />
      </div>
      <div>
       <label className="text-[10px] uppercase text-muted-foreground font-black mb-2 block">Category</label>
       <input 
      ...
      <div>
       <label className="text-[10px] uppercase text-muted-foreground font-black mb-2 block">Role</label>
       <input 
      ...
      <div>
       <label className="text-[10px] uppercase text-muted-foreground font-black mb-2 block">Description</label>
       <textarea 
    ...
    <div className="space-y-8">
     <Card className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
       <div>
        <label className="text-[10px] uppercase text-muted-foreground font-black mb-2 block">Primary Color</label>
        <input 
         type="text" value={formData.color} 
         onChange={(e) => setFormData({...formData, color: e.target.value})}
         className="w-full bg-foreground/5 border border-border rounded-xl p-4 text-foreground outline-none"
        />
       </div>
       <div>
        <label className="text-[10px] uppercase text-muted-foreground font-black mb-2 block">Border Color</label>
        <input 
