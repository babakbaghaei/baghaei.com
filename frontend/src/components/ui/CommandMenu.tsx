...
import { Search, FileText, Home, Phone, Briefcase, Cpu, Laptop, BookOpen, type LucideIcon } from 'lucide-react';
...
export function CommandMenu() {
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-50 flex items-start justify-center pt-[20vh] px-4 backdrop-blur-sm bg-black/50"
    >
      <button
        type="button"
...
function CommandItem({ icon: Icon, text, onSelect, onHover }: { icon: LucideIcon, text: string, onSelect: () => void, onHover?: () => void }) {
  return (
    <Command.Item
      onSelect={onSelect}
