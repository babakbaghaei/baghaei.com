  ...
  <AnimatePresence>
   {isOpen && (
    <motion.div 
     ...
     animate={{ opacity: 1 }}
     exit={{ opacity: 0 }}
     className="fixed inset-0 bg-background z-[99999]"
    ...
    >
     <div className="relative h-full w-full flex flex-col justify-center px-12 overflow-hidden">
      <button
       onClick={onClose}
       className="absolute top-10 left-8 flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors group z-[100000]"
      >
