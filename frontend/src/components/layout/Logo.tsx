    ...
    <div className={`${className} relative group flex items-center justify-center overflow-visible`}>
      <style jsx>{`
        @keyframes glitch-anim-1 {
          ...
          20% { clip-path: inset(40% 0 50% 0); transform: translate(-4px, 4px); }
          30% { clip-path: inset(80% 0 5% 0); transform: translate(4px, -4px); }
          40% { clip-path: inset(10% 0 70% 0); transform: translate(-2px, 2px); }
          50% { clip-path: inset(30% 0 50% 0); transform: translate(2px, -2px); }
          60% { clip-path: inset(10% 0 70% 0); transform: translate(-2px, 2px); }
          70% { clip-path: inset(50% 0 30% 0); transform: translate(2px, -2px); }
          80% { clip-path: inset(20% 0 40% 0); transform: translate(-2px, 2px); }
          90% { clip-path: inset(60% 0 10% 0); transform: translate(2px, -2px); }
          100% { clip-path: inset(30% 0 50% 0); transform: translate(2px, -2px); }
        }
        @keyframes glitch-anim-2 {
          0% { clip-path: inset(10% 0 60% 0); transform: translate(4px, -2px); }
          10% { clip-path: inset(80% 0 5% 0); transform: translate(-4px, 4px); }
          20% { clip-path: inset(30% 0 20% 0); transform: translate(4px, 2px); }
          30% { clip-path: inset(10% 0 80% 0); transform: translate(-2px, -4px); }
          40% { clip-path: inset(50% 0 30% 0); transform: translate(2px, 4px); }
          50% { clip-path: inset(70% 0 10% 0); transform: translate(-4px, 2px); }
          60% { clip-path: inset(20% 0 60% 0); transform: translate(4px, -2px); }
          70% { clip-path: inset(60% 0 20% 0); transform: translate(-4px, 2px); }
          80% { clip-path: inset(40% 0 40% 0); transform: translate(2px, -4px); }
          90% { clip-path: inset(80% 0 10% 0); transform: translate(-2px, 4px); }
          100% { clip-path: inset(70% 0 10% 0); transform: translate(-4px, 2px); }
        }
