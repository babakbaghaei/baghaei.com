  ...
  <>
   <Section className="pt-48 pb-20">
    ...
    {VISIBLE_PROJECTS.length === 0 ? (
     ...
     <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16 mt-20 justify-items-center">
      {filteredProjects.map((project) => (
       <div key={project.id} data-project-frame className="w-full max-w-[320px] h-[360px] md:h-[380px]">
        <ProjectCard
         project={project}
