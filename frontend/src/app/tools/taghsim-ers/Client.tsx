...
function computeShares(opts: {
  ...
  if (sons > 0) {
    ...
    if (father) {
      ...
      // زوجهٔ تنها: ۱/۴ و مازاد با دادگاه.
      heirs.push({ key: 'residual', label: 'مازاد (تعیین تکلیف با دادگاه)', frac: 1 - spouseFrac });
      note = 'زوجه از مازاد بر فرض ۱/۴ رد نمی‌برد؛ تعیین تکلیف باقیماندهٔ ترکه با دادگاه است.';
    }
  }
