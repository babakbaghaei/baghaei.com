   ...
   <div className="max-w-4xl mx-auto px-6 lg:px-16 space-y-16 relative z-10">
    <header className="space-y-6 border-b border-border pb-12">
     <h1 className="text-5xl md:text-7xl font-bold font-display uppercase tracking-tighter leading-none">
      شرایط <span className="text-muted-foreground">استفاده.</span>
     </h1>
    ...
    <div className="space-y-12 font-sans text-foreground/80 leading-loose text-lg text-justify">
     ...
     <section className="space-y-6">
      <h2 className="text-2xl font-bold text-foreground font-display border-r-2 border-primary pr-4">۱. مالکیت معنوی</h2>
     ...
     <section className="space-y-6">
      <h2 className="text-2xl font-bold text-foreground font-display border-r-2 border-primary pr-4">۲. تعهدات کاربر</h2>
     ...
     <section className="space-y-6">
      <h2 className="text-2xl font-bold text-foreground font-display border-r-2 border-primary pr-4">۳. سلب مسئولیت</h2>
      <p className="text-muted-foreground">
     ...
     <section className="space-y-6">
      <h2 className="text-2xl font-bold text-foreground font-display border-r-2 border-primary pr-4">۴. تغییرات در شرایط</h2>
      <p className="text-muted-foreground">
     ...
     <section className="space-y-6">
      <h2 className="text-2xl font-bold text-foreground font-display border-r-2 border-primary pr-4">۵. قانون حاکم</h2>
      <p className="text-muted-foreground">
     ...
     <section className="pt-8 border-t border-border">
      <p className="text-sm text-muted-foreground text-center">
       تماس حقوقی: <span className="text-foreground font-en dir-ltr inline-block">legal@baghaei.com</span>
      </p>
     </section>
    </div>
   </div>
