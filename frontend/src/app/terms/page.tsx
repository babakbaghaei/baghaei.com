...
export const metadata: Metadata = {
 ...
 description: 'شرایط و قوانین استفاده از خدمات و وب‌سایت گروه فناوری بقائی.',
 ...
 return (
  ...
  >
     <section className="space-y-4">
      <p>
       به وب‌سایت گروه فناوری بقائی خوش آمدید. دسترسی و استفاده شما از خدمات ما مشروط به پذیرش و رعایت شرایط زیر است. این توافق‌نامه تمامی بازدیدکنندگان، کاربران و سایر افرادی که به خدمات دسترسی دارند را شامل می‌شود.
      </p>
     </section>
     ...
     <section className="space-y-6">
      ...
      <p className="text-muted-foreground">
       خدمات و محتوای اصلی آن (شامل اما نه محدود به طراحی‌ها، متون، گرافیک، کدها و لوگوها) دارایی انحصاری گروه فناوری بقائی هستند.
      </p>
     ...
     <section className="space-y-6">
      ...
      <p className="text-muted-foreground">
       خدمات ما «همان‌گونه که هست» ارائه می‌شود. اگرچه ما برای پایداری و امنیت تلاش می‌کنیم، اما تضمینی مبنی بر عدم وقفه، خطا یا ویروس نمی‌دهیم. گروه فناوری بقائی در قبال خسارات غیرمستقیم، تصادفی یا تبعی ناشی از استفاده از وب‌سایت مسئولیتی ندارد.
      </p>
     </section>
