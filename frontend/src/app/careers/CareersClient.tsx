  ...
  <>
   <Section className="pt-48 pb-40">
    <div className="max-w-4xl">
     ...
     >
      ما به دنبال مهندسانی هستیم که کدنویسی را فراتر از یک ابزار، و آن را به عنوان یک هنر و دانش معماری می‌بینند. در گروه بقائی، چالش‌های بزرگ منتظر راه‌حل‌های هوشمندانه شماست.
     </motion.p>
    </div>
